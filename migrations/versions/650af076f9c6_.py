...
Revision ID: 650af076f9c6
Revises: 13dd3914e8d9
Create Date: 2022-05-25 23:49:18.873855
...
def upgrade():
    ...
    op.add_column('user', sa.Column('sitecode', sa.String(length=80), nullable=False))
    op.add_column('user', sa.Column('phone_number', sa.String(length=80), nullable=False))
    op.create_unique_constraint(None, 'user', ['sitecode'])
